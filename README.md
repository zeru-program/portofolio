...
## Description
 ini adalah portofolio web pertama ku yang kubuat dengan style ui yang hampir menarik.
...
Install my-project 'My portofolio'

```bash
git clone https://github.com/zeru-program/portofolio.git
cd portofolio
live-server
```
